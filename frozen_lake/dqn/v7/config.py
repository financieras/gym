...
class DQNConfig:
    ...
    # Exploración (Epsilon-Greedy) - OPTIMIZADO PARA EXPLORACIÓN PROLONGADA
    EPSILON_START = 1.0      # Exploración inicial máxima
    EPSILON_END = 0.15       # Exploración mínima MÁS ALTA para mantener exploración
    EPSILON_DECAY = 0.9995   # Factor de decaimiento MÁS LENTO
...
class TrainingConfig:
    ...
    # Duración del entrenamiento - EXTENDIDO PARA MEJOR EXPLORACIÓN
    NUM_EPISODES = 4000     # Número total de episodios (duplicado)
